...
| Owned voice / point of view | gate | For OWNED content (published under the product owner's own byline), the article reads as the owner writing about its own product: facts stated directly, citations carried by links. Neutral/attributed register is used only for the wider market or competitors. | Any third-party framing of the owner's OWN product: "the docs say", "the documentation describes/states/explains", "is documented as", "<owner> says/claims/states", "according to <owner>", "reportedly", "the company". Any one instance is NEEDS_WORK. (Generic "the vendor" for any vendor a buyer evaluates is acceptable.) |
